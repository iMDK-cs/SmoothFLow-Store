          ...
          <div className="flex flex-col lg:flex-row items-center justify-between space-y-4 lg:space-y-0">
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="flex items-center space-x-4 space-x-reverse">
                {/* Visa */}
                <div className="w-20 h-12 bg-white rounded-lg flex items-center justify-center shadow-md border border-gray-200 hover:shadow-lg transition-shadow">
                ...
                {/* Mada */}
                <div className="w-20 h-12 bg-green-600 rounded-lg flex items-center justify-center shadow-md hover:shadow-lg transition-shadow">
                  <div className="flex items-center space-x-1">
                ...
                {/* Bank Transfer */}
                <div className="w-20 h-12 bg-gray-600 rounded-lg flex items-center justify-center shadow-md hover:shadow-lg transition-shadow">
                ...
                {/* Apple Pay */}
                <div className="w-20 h-12 bg-black rounded-lg flex items-center justify-center shadow-md border border-gray-500 hover:shadow-lg transition-shadow">
