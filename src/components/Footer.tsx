...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#0a0e27] text-white relative overflow-hidden footer-rtl arabic-text" dir="rtl">
      ...
      {/* Bottom Bar - Dark like the image */}
      <div className="bg-[#000000] border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col lg:flex-row items-center justify-between space-y-6 lg:space-y-0">
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="flex items-center space-x-4 space-x-reverse">
                ...
                <div className="w-16 h-10 bg-green-500 rounded flex items-center justify-center">
                  <span className="text-xs font-bold text-white">STC Pay</span>
                </div>
              </div>
            </div>
            ...
            <div className="text-center lg:text-left">
              <div className="mb-4">
                <h3 className="text-lg font-bold text-white">SmoothFlow</h3>
                <p className="text-sm text-blue-400">PC Services</p>
              </div>
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-6 left-6 w-14 h-14 bg-blue-600 hover:bg-blue-700 text-white rounded-full flex items-center justify-center transition-all duration-300 z-50 ${
